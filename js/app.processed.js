...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _pianoData = __webpack_require__(328);

	var _synth = __webpack_require__(329);
	...
	var _piano = __webpack_require__(331);
	...
	var App = function (_React$Component) {
	  ...
	  function App(props) {
	    ...
	    _this.state = {
	      keyMap: _pianoData.pianoSounds,
	      midiDevices: _this.props.hasMidi ? WebMidi.inputs : undefined,
	      synth: {
	        osc1WaveType: 'sine',
	        osc2WaveType: 'sine',
	        isChecked1: true,
	    ...
	    _this.getSynth = _this.getSynth.bind(_this);
	    return _this;
	  }
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      ...
	      var midiMap = void 0;
	      var MidiDisplay = void 0;
	      if (this.props.hasMidi) {
	        midiMap = this.state.midiDevices.map(function (x) {
	          return x;
	        });
	        MidiDisplay = midiMap.map(function (x) {
	        ...
	        return React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement(_synth2.default, { getSynth: this.getSynth })
	          ),
	          React.createElement(
	            'div',
	            { id: 'piano' },
	            React.createElement(_piano.Piano, { keyMap: this.state.keyMap, hasMidi: this.props.hasMidi, synth: this.state.synth, context: context })
	          ),
	        ...
	        return React.createElement(
	          ...
	          React.createElement(
	            'div',
	            { id: 'piano' },
	            React.createElement(_piano.Piano, { keyMap: this.state.keyMap, hasMidi: false, synth: this.state.synth })
	          ),
	          React.createElement(_footer2.default, null)
	        );
	      }
	...
	WebMidi.enable(function (err) {
	  if (err || !err) {
	    ...
	    ReactDOM.render(React.createElement(App, { hasMidi: hasMidi }), document.getElementById('root'));
	  }
	});
...
/***/ (function(module, exports) {
	...
	exports.pianoSounds = pianoSounds;
	exports.keyUpAcc = keyUpAcc;
	exports.keyUpNat = keyUpNat;
	exports.keyDownAcc = keyDownAcc;
	exports.keyDownNat = keyDownNat;
...
/***/ (function(module, exports) {
	...
	var Synth = function (_React$Component) {
	  ...
	  function Synth(props) {
	    ...
	    };_this.props.getSynth(_this.state);
	    _this.enableOsc = _this.enableOsc.bind(_this);
	    _this.handleVolume = _this.handleVolume.bind(_this);
	    _this.handleWave = _this.handleWave.bind(_this);
	    return _this;
	  }

	  _createClass(Synth, [{
	    key: 'enableOsc',
	    value: function enableOsc(e) {
	    ...
	    value: function render() {
	      ...
	      return React.createElement(
	        ...
	        React.createElement(
	          'h3',
	          null,
	          'Oscillator Settings (sort of works, only single osc at the moment)'
	        ),
	        React.createElement(
	          'label',
	          { 'for': 'volume' },
	        ...
	        React.createElement('input', { type: 'range', name: 'volume', value: this.state.volume, min: '0', max: '100', onInput: this.handleVolume }),
	        React.createElement(
	          'form',
	          { id: 'osc1' },
	          React.createElement(
	          ...
	          React.createElement('input', { type: 'checkbox', name: 'Oscillator 1', onChange: this.enableOsc, checked: this.state.isChecked1 }),
	          React.createElement(
	            'select',
	        ...
	        React.createElement(
	          ...
	          React.createElement('input', { type: 'checkbox', name: 'Oscillator 2', onChange: this.enableOsc, checked: this.state.isChecked2 }),
	          React.createElement(
	            'select',
	            { onChange: this.handleWave },
	            React.createElement(
	  ...
	  _createClass(Footer, [{
	    ...
	    value: function render() {
	      return React.createElement(
	        "div",
	        { id: "footer" },
	        "Created by Stoosh with React",
	        React.createElement(
	          "div",
	          null,
	          React.createElement(
	            "a",
	            { href: "https://codepen.io/stoosh/" },
	            React.createElement("i", { "class": "fa fa-codepen", "aria-hidden": "true" })
	          ),
	          React.createElement(
	            "a",
	            { href: "https://github.com/SeanDoh" },
	            React.createElement("i", { "class": "fa fa-github-square", "aria-hidden": "true" })
	          ),
	          React.createElement(
	            "a",
	            { href: "https://twitch.com/stooshbatis" },
	            React.createElement("i", { "class": "fa fa-twitch", "aria-hidden": "true" })
	          ),
	          React.createElement(
	            "a",
	            { href: "https://twitter.com/stooshbatis" },
	            React.createElement("i", { "class": "fa fa-twitter", "aria-hidden": "true" })
	          ),
	          React.createElement(
	            "a",
	            { href: "https://soundcloud.com/stooshbatis" },
	            React.createElement("i", { "class": "fa fa-soundcloud", "aria-hidden": "true" })
	          )
	        )
	      );
	    }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _pianoKey = __webpack_require__(332);
	...
	function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } // piano component houses pianokeys
	...
	var Piano = function (_React$Component) {
	  ...
	  _createClass(Piano, [{
	    ...
	    value: function render() {
	      ...
	      var pianoKeys = this.props.keyMap.map(function (x) {
	        return React.createElement(_pianoKey2.default, { note: x.note,
	          type: x.type,
	          ...
	          freq: x.freq,
	          midi: x.midi,
	          hasMidi: _this2.props.hasMidi,
	          synth: _this2.props.synth,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } // PianoKey component is an indivdual key on piano
	...
	var Pianokey = function (_React$Component) {
	  _inherits(Pianokey, _React$Component);

	  function Pianokey(props) {
	    _classCallCheck(this, Pianokey);

	    // set state here
	    var _this = _possibleConstructorReturn(this, (Pianokey.__proto__ || Object.getPrototypeOf(Pianokey)).call(this, props));

	    _this.state = {
	      // animation styles
	      dTypeNat: _pianoData.keyUpNat,
	      dTypeAcc: _pianoData.keyUpAcc,
	      // prevent repeating of keyboard notes
	      beingHeld: false,
	      // works midi
	      // check hasMidi and there are devices connected
	      midiDevice: _this.props.hasMidi && WebMidi.inputs.length > 0 ? WebMidi.inputs[0] : undefined,
	      // create osc and gain for sound in component constructor
	      osc: _this.props.context.createOscillator(),
	      gain: _this.props.context.createGain()
	      // assign osc values and such
	    };_this.state.osc.frequency.value = _this.props.freq;
	    _this.state.osc.type = _this.props.synth.osc1WaveType;
	    _this.state.gain.gain.value = .000001;
	    _this.state.osc.connect(_this.state.gain);
	    _this.state.osc.start();
	    _this.state.gain.connect(_this.props.context.destination);

	    _this.handleKeyPress = _this.handleKeyPress.bind(_this);
	    _this.handleMidi = _this.handleMidi.bind(_this);
	  ...
	  _createClass(Pianokey, [{
	    ...
	    value: function handleClick(e) {
	      if (e.type == 'mousedown') {
	        var divOrSpan = e.nativeEvent.srcElement.id == this.props.note || e.nativeEvent.srcElement.className == this.props.note;
	        ...
	        var _divOrSpan = e.nativeEvent.srcElement.id == this.props.note || e.nativeEvent.srcElement.className == this.props.note;
	        if (_divOrSpan && this.state.beingHeld == true) {
	          this.setState({ beingHeld: false });
	          this.handleKeyUp();
	          this.endOsc();
	        }
	      } else if (e.type == "mouseenter") {
	        var _divOrSpan2 = e.nativeEvent.toElement.id == this.props.note || e.nativeEvent.toElement.className == this.props.note;
	        if (_divOrSpan2 && this.state.beingHeld == false && e.nativeEvent.buttons == 1) {
	          this.setState({ beingHeld: true });
	          this.handleKeyDown();
	          this.createOsc();
	        }
	      } else if (e.type == 'mouseleave') {
	        var _divOrSpan3 = e.nativeEvent.srcElement.id == this.props.note || e.nativeEvent.srcElement.className == this.props.note;
	        if (_divOrSpan3 && this.state.beingHeld == true) {
	          this.setState({ beingHeld: false });
	          this.handleKeyUp();
	          this.endOsc();
	        }
	    ...
	    value: function handleKeyDown() {
	      if (this.props.type == 'natural') {
	        this.setState({ dTypeNat: _pianoData.keyDownNat });
	      } else {
	        this.setState({ dTypeAcc: _pianoData.keyDownAcc });
	      }
	    }
	    // handles key animation
	    ...
	    value: function handleKeyUp() {
	      if (this.props.type == 'natural') {
	        this.setState({ dTypeNat: _pianoData.keyUpNat });
	      } else {
	        this.setState({ dTypeAcc: _pianoData.keyUpAcc });
	      }
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      if (this.props.type == 'natural') {
	        return React.createElement(
	          ...
	          React.createElement('audio', { src: this.props.sound }),
	          React.createElement(
	            'span',
